      ...
      <div class="sm:w-1/2">
        <div class="p-5 w-4/5 mx-auto text-left font-raleway">
          ...
          <form @submit="register">
            ...
            <button :disabled="name.length < 6 || password.length < 6 || username.length < 3"
                    class="bg-green-400 p-5 text-white" type="submit">
              Sign Up
              <font-awesome-icon :icon="['fas', 'arrow-right']" class="ml-3"/>
            </button>
          </form>
        </div>
      </div>
